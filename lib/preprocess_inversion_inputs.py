...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Preprocess BedMachine and MEaSUREs data to create BISICLES initial condition."
    )
    parser.add_argument(
        "output_nc",
        type=str,
        help="Path to output netCDF file for BISICLES initial condition."
    )
    parser.add_argument(
        "bedmachine_nc",
        type=str,
        help="Path to BedMachine netCDF file."
    )
    parser.add_argument(
        "measures_nc",
        type=str,
        help="Path to MEaSUREs velocity netCDF file."
    )
    return parser
...
def main():
    ...
    preprocess(args.output_nc, args.bedmachine_nc, args.measures_nc)
