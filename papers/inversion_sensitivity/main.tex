...
The spatial patterns of ice thicknes change are broadly similar across the ensemble, with most mass loss occuring in regions of West Antarctica: the Amundsen Sea sector, the Siple coast, and the Weddell sea sector. However, the extent of mass loss in these regions depends on parameter choices, with high variance along Thwaites glacier, Foundations glacier, Denman glacier, and the Siple coast (Figure~\ref{fig:spatial}).

•	This sea level mostly comes from West Antarctica: Amundsen Sea sector, the Siple coast, and Weddell sea sector.
•	The major ice shelves collapse in all simulations by 2300, but their stability at 2100 is parameter dependent.
 
 
•	Pine island glacier is mostly stable by 2100 but some parameter combinations trigger a collapse by 2300, contributing greatly to sea level rise.
•	Grounding line retreat in Thwaites and the Siple coast also contribute to sea level rise in some simulations.
