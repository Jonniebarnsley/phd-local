...
Although the sensitivity to one of the inversion parameters is high at 2100, the overall sensitivity to inversion choices is otherwise lower than other commonly perturbed parameters, particularly on longer timescales. 
